          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                EMBAMUNAI TOO KZ is dedicated to being the partner of choice for oil and gas companies worldwide. We combine deep technical expertise with cutting-edge technology to deliver drilling, well services, and refinery solutions that exceed expectations.
              </p>
